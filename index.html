...
<head>
   ...
   <link rel="stylesheet" href="/page-for-memory/pages/main-page/css/main-page.css">
...
<body>
   <div class="wrapper">
      ...
      <header class="header">
         <div class="header__top-button-container">
            <a href="/page-for-memory/pages/settings-page/settings-page.html" class="settings"><ion-icon
                  class="icon-settings" name="settings-outline"></ion-icon></a>
            <div class="header__top-button-title">Memory</div>
            <img src="/page-for-memory/img/Menu/Ава2(удалить).jpg" alt="#" class="profile">
         </div>
         <div class="header-score-container">
            <div class="memany-container currency-container">
               <img src="/page-for-memory/pages/main-page/img/memanyImg.svg" alt="memany">
               0050
            </div>
            ...
            <div class="iq-container currency-container">
               <img src="/page-for-memory/pages/main-page/img/brainImg.svg" alt="iq">
               207 IQ
            </div>
         </div>
      ...
      <div class="page-games-container">
         ...
         <div class="container-list-games">
            <a href="/page-for-memory/pages/firstGamePage-number/game-number.html">
            ...
            <a href="/page-for-memory/pages/thirdGame-images/game-images.html">
               <div class="item-games yellow-item">
                  <img src="/page-for-memory/pages/main-page/img/games-page/ImageIcon.svg" alt="">
               </div>
            </a>
            <a href="/page-for-memory/pages/Game-REAPEAT/gameREPEAT.html">
               <div class="item-games"><img src="/page-for-memory/pages/main-page/img/games-page/shapesImg.svg" alt="">
               </div>
            </a>
            <a href="/page-for-memory/pages/fourthGame-colors/game-colors.html">
               <div class="item-games yellow-item">
                  <div class="colorsGame-title"><ion-icon class="img-colors" name="color-palette-outline"></ion-icon>
                  </div>
               </div>
            </a>
            <div class="item-games"><img src="/page-for-memory/pages/main-page/img/games-page/musicImg.svg" alt="">
            </div>
      ...
      <div class="page-store-container">
         ...
         <img src="/page-for-memory/img/Menu/Time.svg" alt="Время" class="timeoclock">
         ...
         <div class="ads">
            ...
            <img src="/page-for-memory/img/Menu/NOADS.png" alt="" class="noads">
         </div>
   ...
   <script src="/page-for-memory/pages/main-page/js/main-page.js"></script>
</body>
